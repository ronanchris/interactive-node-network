...
function fixFinalPaths(filePath: string) {
  ...
  if (filePath.startsWith('docs/')) {
    ...
    for (const file of readmeFiles) {
      ...
      updatedContent = updatedContent.replace(new RegExp(`\`\\.\\.\\.\\./${file}\``, 'g'), `\`${relativePath}\``);
      updatedContent = updatedContent.replace(new RegExp(`\`\\.\\.learning/${file}\``, 'g'), `\`${relativePath}\``);
      updatedContent = updatedContent.replace(new RegExp(`\`\\.\\.performance/${file}\``, 'g'), `\`${relativePath}\``);
    }
  }
  ...
  // Fix paths to files in errors directory
  if (filePath.startsWith('docs/errors/')) {
    const errorFiles = [
      'monitoring.md',
      'logging.md',
      'validation.md',
  ...
  // Fix paths to files in technical directory
